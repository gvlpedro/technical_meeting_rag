...
from agents.service import generate_architecture_questions_for_batch, generate_data_contract_questions_for_batch
...
async def test_generate_data_contract_questions_for_batch_returns_the_drafted_result(monkeypatch, tmp_path):
    ...
    mentioned_data_contracts = [
        {"name": "checkout-completed", "producer": "checkout service", "consumer": "order history", "action": "modified"}
    ]
