...
| Metric | 2026-09-16 | 2026-09-17 | 2026-09-18 | 2026-09-18 v1 | 2026-09-18 v2 | 2026-09-18 v3 | 2026-09-18 v4 | 2026-09-19 | 2026-09-19 v1 | 2026-09-19 v2 | 2026-09-19 v3 | 2026-09-19 v4 | 2026-09-19 v5 | 2026-09-25 |
|---|---|---|---|---------------|---|---------------|---------------|---|---|---|---|---|---|---|
...
| Fast suite (`make test`) — pass rate | - | - | - | -             | 130/130 | 134/134       | 139/139 | = | 146/146 | 148/148 | = | 152/152 | 153/153 | 168/168 |
...
| Chat grounding — citation verification, new unit tests | - | - | - | -             | - | -             | - | - | - | - | - | - | - | 4/4 |
| Chat retrieval — Corrective RAG (relaxed-retry), new unit tests | - | - | - | -             | - | -             | - | - | - | - | - | - | - | 5/5 |
| Chat retrieval — Query Expansion, new unit tests | - | - | - | -             | - | -             | - | - | - | - | - | - | - | 3/3 |
| Gold chat-eval golden-set — case count (real LLM, `make test-gold-chat-eval`) | - | - | - | -             | - | -             | - | - | - | - | - | - | - | 4 |
| Gold chat-eval golden-set — entity_hit rate | - | - | - | -             | - | -             | - | - | - | - | - | - | - | 4/4 |
| Gold chat-eval golden-set — citation_hit rate | - | - | - | -             | - | -             | - | - | - | - | - | - | - | 4/4 |
| Gold chat-eval golden-set — RAGAS faithfulness / context_recall | - | - | - | -             | - | -             | - | - | - | - | - | - | - | 1.0 / 1.0 (4/4 each) |
| Gold chat-eval golden-set — RAGAS answer_relevancy / context_precision | - | - | - | -             | - | -             | - | - | - | - | - | - | - | null / null — `ragas==0.4.3` hangs on both in this environment, 4/4 timeouts each (see `test_chat_eval.py`'s own docstring); `faithfulness`/`context_recall` unaffected |
