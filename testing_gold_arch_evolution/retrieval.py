"""This module re-exports the Gold retrieval functions from agents.gold_service.
...
from agents.gold_service import answer_question, embed_question, top_k_gold_evolution
